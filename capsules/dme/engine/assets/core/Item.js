class Item extends Asset {
    constructor(name, desc) {
        ...
        this.rare = rare; //biprim code and rarity
        this.eq = eq; //bodyparts and equip code
        
        this.val = val; //int []
        this.dmgStat = dmgStat; //double []
        this.use = use; //biprimitive []
        
        this.status = status; //[] status wet, dry, broken etc.
    }
