module.exports = class AnomalyScale extends Module {
  getContent() {
    return p();
  }
};

function tsz_anomscal_HTML() {
  main_header.innerHTML =
    n2 +
    '<p id="p1">The Schlong of Zen </p>' +
    n2 +
    '<p id="p2">Anomaly Scale</p>' +
    n1;
}

function tsz_anomscal_functions() {
  const Character = require('../../js/tsz/character.js');
