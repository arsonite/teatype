module.exports = class RGBToHEX extends Module {
  getContent() {
    return p();
  }
};

function home_rgbhex_HTML() {
  main_header.innerHTML =
    n2 + '<p id="p1">Home </p>' + n2 + '<p id="p2">RGB & Hex</p>' + n1;
}

function home_rgbhex_functions() {
  /*
    <div id="container">
    ...
    background: -moz - linear - gradient(left, #F00 0 % , #FF0 16.66 % , #0F0 33.33%, # 0 FF 50 % ,
    #00F 66.66%, # F0F 83.33 % , #F00 100 % );
    background: -webkit - linear - gradient(left, #F00 0 % , #FF0 16.66 % , #0F0 33.33%, # 0 FF 50 % ,
    #00F 66.66%, # F0F 83.33 % , #F00 100 % );
    background: -ms - linear - gradient(left, #F00 0 % , #FF0 16.66 % , #0F0 33.33%, # 0 FF 50 % ,
    #00F 66.66%, # F0F 83.33 % , #F00 100 % );
    background: -o - linear - gradient(left, #F00 0 % , #FF0 16.66 % , #0F0 33.33%, # 0 FF 50 % ,
    #00F 66.66%, # F0F 83.33 % , #F00 100 % );
    }
    ...
    height: 100 % ;
    position: relative;
    box - shadow: inset 0 px 0 px 2 px 0 px# DDD;
    }
    ...
    cursor: pointer;
    border - color: #DDD;
    box - shadow: inset 0 px 0 px 5 px 0 px# CCC;
    }

    #
    picker - samples# add - icon: before, #picker - samples# add - icon: after {
    content: "";
    position: absolute;
    background - color: #EEE;
    box - shadow: 0 0 1 px 0# EEE;
    }
    ...
    #
    picker - samples# add - icon: hover: before, #picker - samples# add - icon: hover: after {
    background - color: #DDD;
    box - shadow: 0 0 1 px 0# DDD;
    }
    ...
    width: 40 % ;
    padding: 30 px 9 % 70 px 11 % ;

    background - image: url('https://mdn.mozillademos.org/files/6075/drop.png');
    background - repeat: no - repeat;
    background - position: left 35 px top 60 % ;

    text - align: right;

    border: 3 px dashed rgb(221, 221, 221);
    border - radius: 15 px;
